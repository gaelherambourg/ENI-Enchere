	...
	<%@ include file="layouts/header.jsp" %>
		...
		<main>
			...
			<form class="form-register needs-validation" action="MonProfile"
				...
				<div class="row">
					<div class="col-md-6 mb-3">
						<label for="pseudo">Pseudo</label> <input type="text"
							...
							maxlength="30" required value="${sessionScope.utilisateur.pseudo}">
				...
				<div class="row">
					<div class="col-md-6 mb-3">
						<label for="firstname">Prénom</label> <input type="text"
							...
							value="${sessionScope.utilisateur.prenom}" maxlength="30" required>
						<div class="invalid-feedback">Ce champ est invalide !</div>
					</div>
				...
				<div class="row">
					<div class="col-md-6 mb-3">
						<label for="password">Mot de passe</label> <input type="password"
							...
							minlength="6" maxlength="30" value="${sessionScope.utilisateur.mot_de_passe}" required>
						<div class="invalid-feedback">Ce champ est invalide !</div>
					</div>
				...
				<button class="btn btn-danger btn-lg btn-block" data-toggle="modal" data-target="#validation-supression">Supression du compte</button>
				
				<!-- Supression -->
				<div class="modal fade" id="validation-supression" tabindex="-1" aria-labelledby="validation-supression" aria-hidden="true">
				  <div class="modal-dialog">
				    <div class="modal-content">
				      ...
				      <div class="modal-body">
				        <p><strong>Vos information seront définitivement perdue !</strong><br>ête vous sur de vouoir suprimer votre compte ?</p>
				      </div>
